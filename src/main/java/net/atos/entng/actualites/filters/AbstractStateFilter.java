...
public abstract class AbstractStateFilter extends AbstractBaseFilter {

	protected final InfoState allowedState;
	
	public AbstractStateFilter(final InfoState allowedState) {
		super();
	...
	public void authorize(final HttpServerRequest request, final Binding binding, final UserInfos user, final Handler<Boolean> handler) {
		try {
			...
			request.pause();
			infoService.canDoByState(user, threadId, infoId, sharedMethod, allowedState, new Handler<Boolean>(){
				@Override
