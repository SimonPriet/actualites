...
public abstract class ManageableResourcesControllerHelper extends MongoDbControllerHelper {

	protected final String managedCollection;
	protected final String type;
	protected ShareService shareService;
	
	public ManageableResourcesControllerHelper(String managedCollection) {
		this(managedCollection, null);
	}
	
	public ManageableResourcesControllerHelper(String managedCollection, Map<String, List<String>> groupedActions) {
